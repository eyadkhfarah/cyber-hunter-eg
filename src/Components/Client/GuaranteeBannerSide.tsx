...
export const GuaranteeBannerSide: React.FC = () => (
  <section className="relative overflow-hidden group">
    ...
    <div className="relative z-10 p-8 flex flex-col lg:items-start items-center justify-between gap-8">
      {/* Visual Seal / Icon */}
      ...
      <div className="text-center md:text-left">
        <div className="gird gap-3 mb-3">
          ...
          <div className="mx-auto md:mx-0 px-3 py-1 bg-emerald-950/30 border border-emerald-400/30 rounded-md font-mono text-[10px] text-emerald-200 tracking-widest w-fit uppercase">
            Verified_Hands_On
          </div>
        </div>
        
        <p className="text-emerald-50">
          Every CyberHunter course is architected with a labs-first philosophy. We guarantee that you will spend more time in our virtual cyber ranges than in lecture slides, ensuring job-ready competence.
        </p>
        ...
        <div className="mt-6 flex items-center justify-center md:justify-start gap-4 text-emerald-200/60">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[7px] font-mono uppercase tracking-[0.2em]">Real_World_Labs_Active</span>
          </div>
          <div className="w-1 h-1 rounded-full bg-emerald-400" />
          <div className="flex items-center gap-2">
            <CheckCircle className="w-3 h-3" />
            <span className="text-[7px] font-mono uppercase tracking-[0.2em]">Job_Ready_Validated</span>
          </div>
        </div>
      </div>
    </div>
