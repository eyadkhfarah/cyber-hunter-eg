    ...
    <main className="container mx-auto md:px-24 px-6 py-16">
      <header className="max-w-3xl mx-auto text-center mb-12">
        ...
        <p className="text-lg text-slate-600">
          CyberHunter provides comprehensive cybersecurity solutions to protect
          your business. Our expert services include Digital Forensics &
          Incident Response (DF&IR), proactive Threat Hunting, 24/7 SOC as a
          Service, and Phishing Simulations.
        </p>
      </header>
      ...
      <section>
        ...
        <div className="grid md:grid-cols-2 gap-5">
          {cyberSecurityServices.map((service, i) => {
            return (
              <div
                className="bg-dark text-white p-5 rounded-3xl md:flex grid gap-5"
                key={i}
              >
      ...
      <section>
        <h3 className="font-bold text-xl text-dark text-center">
          More services coming{" "}
          <span className="text-blue-500 uppercase">soon...</span>
        </h3>
      </section>
      <section>
        <StepByStep />
